...
export async function purgeAll(): Promise<void> {
  ...
  try {
    for (const key of ['witness_share_bundle', 'witness_share_kbundle', 'witness_mesh_key', 'witness_ingest_url', 'witness_ingest_token', 'witness_mesh_peers', 'witness_callsign']) {
